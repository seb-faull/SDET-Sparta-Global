...
describe "show the depths of rspec" do  #describe = keyword for namespace

  context "work through the different types of Rspec matchers" do  #context = keyword for namespace

    it 'should test that equality matchers are different' do
      a = 1
      b = 1
      c = 1.0
      #match for equality = eq
      #match for equality of class as well = eql
    ...
    it 'should test the various different type of comparison matcher' do
      ...
      it 'should test the various class type matchers' do
        ...
        expect(h).to be_a_kind_of(Hash) #check if h is a hash
      end
